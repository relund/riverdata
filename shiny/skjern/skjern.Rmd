...
if (input$iDataSal == ">73False") dat <- dat %>% dplyr::filter(!`>73cm`)
if (input$iDataSal == ">73True") dat <- dat %>% dplyr::filter(`>73cm`)
dat <- dat %>% 
