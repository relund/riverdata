...
<a class="weatherwidget-io" href="https://forecast7.com/da/56d319d17/karup/" data-label_1="KARUP" data-font="Ubuntu" data-days="5" data-theme="original" >KARUP</a>
<script>
!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
</script>

<a class="weatherwidget-io" href="https://forecast7.com/da/56d399d00/haderup/" data-label_1="HAGEBRO" data-font="Ubuntu" data-days="5" data-theme="gray" >HAGEBRO</a>
<script>
!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
</script>

<a class="weatherwidget-io" href="https://forecast7.com/da/56d579d03/skive/" data-label_1="SKIVE" data-font="Ubuntu" data-days="5" data-theme="original" >SKIVE</a>
<script>
!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='https://weatherwidget.io/js/widget.min.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','weatherwidget-io-js');
</script>
...
data-lat="56.407980"
data-lng="9.011550"
data-appid="f10a0ad36b5f5fb14d30b7f35ac95343">
</div>
...
```{r}
tags$iframe(width="100%", height="100%", seamless = NA,  src="https://embed.windy.com/embed2.html?lat=56.385&lon=9.005&zoom=11&level=surface&overlay=wind&menu=&message=true&marker=true&calendar=now&pressure=&type=map&location=coordinates&detail=true&detailLat=56.408&detailLon=9.009&metricWind=m%2Fs&metricTemp=%C2%B0C&radarRange=-1")
```
...
renderPlot({
  # res <- pivot_longer(res, 3:5)
  ggplot(res, aes(x = Length, y = Avg)) + 
    geom_line(aes(group = Period, color = Period)) +
    labs(title = "Vægt som en funktion af længde", color = "Periode") +
    ylab("Vægt") + theme(legend.position="bottom") + 
...
<!-- $$ v = `r round(exp(mod$coefficients[1]),8)` \cdot l^{`r round(mod$coefficients[2],2)`}$$ -->
<!-- Estimaterne med et 95% konfidensinterval bliver: -->
...
tab <- tab %>% 
  transmute('Længde' = Length, 
            ...
            'Efterår' = str_c(format(round(Avg2,1), 1), " [",format(round(Lower2,1), digits = 1),",",format(round(Upper2,1), digits = 1),"]"),
            'Vinter' = str_c(format(round(Avg3,1), 1), " [",format(round(Lower3,1), digits = 1),",",format(round(Upper3,1), digits = 1),"]")
            ) 
